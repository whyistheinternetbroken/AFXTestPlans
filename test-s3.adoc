...
|===
| Section | Details
| Test 14 | Tester: ________________  Date: ________________
...
. An S3 user needs to map to a corresponding NAS user. If you want to use the root user, you need to generate a passkey for root. For root user, click the  and “Regenerate key” and then save the information.
