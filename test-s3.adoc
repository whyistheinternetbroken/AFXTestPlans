...
+
image::images/test-s3-image-02.png[width=10%,link=images/test-s3-image-02.png]

. Click on the “Settings” tab and then the settings icon on the S3 section.
+
image::images/test-s3-image-04.png[width=10%,link=images/test-s3-image-04.png]

. Give the S3 server a name and configuration. This name should be a FQDN that is resolvable in DNS.
+
image::images/test-s3-image-05.png[width=10%,link=images/test-s3-image-05.png]
...
+
image::images/test-s3-image-06.png[width=10%,link=images/test-s3-image-06.png]
...
+
image::images/test-s3-image-09.png[width=10%,link=images/test-s3-image-09.png]
