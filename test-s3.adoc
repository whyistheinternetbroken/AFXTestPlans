...
+
image::images/test-s3-image-08.png[width=20%,link=images/test-s3-image-08.png]
+
...
+
image::images/test-s3-image-12.png[width=10%,link=images/test-s3-image-12.png]

. This will create your access/secret keys. Save for later use.
+
image::images/test-s3-image-13.png[width=10%,link=images/test-s3-image-13.png]
...
+
image::images/test-s3-image-15.png[width=10%,link=images/test-s3-image-15.png]
...
+
image::images/test-s3-image-16.png[width=10%,link=images/test-s3-image-16.png]
+
image::images/test-s3-image-17.png[width=10%,link=images/test-s3-image-17.png]
