...
+
image::images/test-s3-image-01.png[width=20%,link=images/test-s3-image-01.png]

. Click on the desired SVM and look for the “Protocols” section. That shows if S3 is enabled.
+
image::images/test-s3-image-02.png[width=25%,link=images/test-s3-image-02.png]

. Click on the “Settings” tab and then the settings icon on the S3 section.
+
image::images/test-s3-image-04.png[width=25%,link=images/test-s3-image-04.png]

. Give the S3 server a name and configuration. This name should be a FQDN that is resolvable in DNS.
+
image::images/test-s3-image-05.png[width=25%,link=images/test-s3-image-05.png]
...
+
image::images/test-s3-image-06.png[width=25%,link=images/test-s3-image-06.png]
...
+
image::images/test-s3-image-09.png[width=25%,link=images/test-s3-image-09.png]
...
+
image::images/test-s3-image-12.png[width=25%,link=images/test-s3-image-12.png]

. This will create your access/secret keys. Save for later use.
+
image::images/test-s3-image-13.png[width=25%,link=images/test-s3-image-13.png]
...
+
image::images/test-s3-image-15.png[width=25%,link=images/test-s3-image-15.png]
...
+
image::images/test-s3-image-16.png[width=25%,link=images/test-s3-image-16.png]
+
image::images/test-s3-image-17.png[width=25%,link=images/test-s3-image-17.png]

. Your bucket will be listed. Clicking on it allows you to manage it further and view the URL.
+
image::images/test-s3-image-18.png[width=25%,link=images/test-s3-image-18.png]
