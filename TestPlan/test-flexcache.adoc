...
. Peer the clusters (if necessary) This step may not be necessary if you’ve already peered the clusters for SnapMirror. Follow the steps in xref:test-04-data-migration.adoc[Test 4: Data migration (optional)] to peer clusters.
...
+
image::images/test-flexcache-image-09.png[width=25%,link=images/test-flexcache-image-09.png]
...
+
image::images/test-flexcache-image-12.png[width=20%,link=images/test-flexcache-image-12.png]
+
...
+
image::images/test-flexcache-image-14.png[width=30%,link=images/test-flexcache-image-14.png]
+
image::images/test-flexcache-image-15.png[width=30%,link=images/test-flexcache-image-15.png]
