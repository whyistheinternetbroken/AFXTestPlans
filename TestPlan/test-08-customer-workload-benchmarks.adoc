...
. Generate datasets. For detailed steps on how to run the benchmarks, see xref:appendix-spec-sfs.adoc[SPEC SFS 2020] and xref:appendix-mlcommons.adoc[MLCommons / MLPerf Storage].
