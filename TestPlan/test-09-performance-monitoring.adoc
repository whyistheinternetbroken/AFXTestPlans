...
For a compact copy/paste sequence covering live views, sample capture, protocol filters, and pNFS/session-trunking validation, see xref:benchmark-configuration-reference.adoc#statistics-capture-commands[Statistics capture commands]. The examples below explain how to interpret the workflow and output.
...
|===
| xref:appendix-synthetic-benchmarks.adoc[< Previous]
