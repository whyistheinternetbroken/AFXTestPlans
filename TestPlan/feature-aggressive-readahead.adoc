...
*Note:* The following section covers statistics monitoring for aggressive readahead. Some introductory content repeats <<aggressive-readahead>> for context. Both sections were present in the original source document and are preserved here.
