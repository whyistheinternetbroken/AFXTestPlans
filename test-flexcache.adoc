...
. Peer the clusters (if necessary) This step may not be necessary if you’ve already peered the clusters for SnapMirror. Follow the steps in xref:test-04-data-migration.adoc[Test 4: Data migration] to peer clusters.
