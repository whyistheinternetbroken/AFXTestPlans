...
+
image::images/test-flexcache-image-02.png[width=25%,link=images/test-flexcache-image-02.png]

. Select the peered cluster and the desired SVM to peer.
+
image::images/test-flexcache-image-03.png[width=50%,link=images/test-flexcache-image-03.png]

. Specify FlexCache as the application to use.

. Create the FlexCache volume Click on Storage -> Volumes and click “Add”
+
image::images/test-flexcache-image-04.png[width=25%,link=images/test-flexcache-image-04.png]

. In the Add volume window, click “More options”
+
image::images/test-flexcache-image-05.png[width=50%,link=images/test-flexcache-image-05.png]
...
+
image::images/test-flexcache-image-06.png[width=50%,link=images/test-flexcache-image-06.png]
...
+
image::images/test-flexcache-image-07.png[width=50%,link=images/test-flexcache-image-07.png]

. Click save. The FlexCache will be created.
+
image::images/test-flexcache-image-08.png[width=50%,link=images/test-flexcache-image-08.png]
...
+
image::images/test-flexcache-image-11.png[width=50%,link=images/test-flexcache-image-11.png]
...
+
image::images/test-flexcache-image-13.png[width=50%,link=images/test-flexcache-image-13.png]
...
+
image::images/test-flexcache-image-14.png[width=50%,link=images/test-flexcache-image-14.png]
+
image::images/test-flexcache-image-15.png[width=50%,link=images/test-flexcache-image-15.png]
