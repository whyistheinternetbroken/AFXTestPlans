...
image::images/test-11-image-01.png[width=50%,link=images/test-11-image-01.png,border]
...
image::images/test-11-image-02.png[width=50%,link=images/test-11-image-02.png,border]

Use the “Add nodes” screen to fill in your information. Management IP addresses can be added manually or by using a subnet.

image::images/test-11-image-03.png[width=50%,link=images/test-11-image-03.png,border]
image::images/test-11-image-04.png[width=50%,link=images/test-11-image-04.png,border]
...
image::images/test-11-image-05.png[width=50%,link=images/test-11-image-05.png,border]
