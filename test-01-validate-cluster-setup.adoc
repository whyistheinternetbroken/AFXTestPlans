...
. Log into the System Manager GUI via https://[clus_mgmt_IP] The system dashboard will show errors, warnings, capacity information, and a high-level overview of the storage hardware.
+
image::images/test-01-image-01.png[width=50%,link=images/test-01-image-01.png]

. Click on “Errors” to view any issues the cluster may be having. This will take you to Events & Jobs -> Events.
+
image::images/test-01-image-02.png[width=50%,link=images/test-01-image-02.png]

. Click on System Alerts to see specific alerts.
+
image::images/test-01-image-03.png[width=50%,link=images/test-01-image-03.png]
...
+
image::images/test-01-image-04.png[width=50%,link=images/test-01-image-04.png]
...
+
image::images/test-01-image-06.png[width=50%,link=images/test-01-image-06.png]

*Test procedure – CLI:*

. Log in to the NetApp AFX CLI Verify cluster health.
+
[source,console]
----
AFX::*> set advanced
...
+
--
* NFSv4.1 enabled status
* NFSv4 ID domain
* NFSv4.1 pNFS configuration
* NFSv4.1 trunking status
* TCP maximum transfer size
* NFSv3 enabled status
* NFSv3 64-bit identifier support
* NFSv4 64-bit identifier support
* NFSv4.1 read delegation settings
* NFSv4.1 write delegation settings
* RDMA support status
--
