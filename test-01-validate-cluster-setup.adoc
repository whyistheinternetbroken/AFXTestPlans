...
+
image::images/test-01-image-01.png[width=50%,link=images/test-01-image-01.png,border]

. Click on “Errors” to view any issues the cluster may be having. This will take you to Events & Jobs -> Events.
+
image::images/test-01-image-02.png[width=50%,link=images/test-01-image-02.png,border]

. Click on System Alerts to see specific alerts.
+
image::images/test-01-image-03.png[width=50%,link=images/test-01-image-03.png,border]
...
+
image::images/test-01-image-04.png[width=50%,link=images/test-01-image-04.png,border]
...
+
image::images/test-01-image-06.png[width=50%,link=images/test-01-image-06.png,border]
