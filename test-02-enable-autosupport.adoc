...
image::images/test-02-image-01.png[width=50%,link=images/test-02-image-01.png,border]
image::images/test-02-image-02.png[width=50%,link=images/test-02-image-02.png,border]

Test AutoSupport connectivity

image::images/test-02-image-03.png[width=50%,link=images/test-02-image-03.png,border]
image::images/test-02-image-04.png[width=50%,link=images/test-02-image-04.png,border]
