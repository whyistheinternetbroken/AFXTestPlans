...
<b>Note:</b> The following section covers statistics monitoring for aggressive readahead. Some introductory content repeats the configuration section above for context. Both sections were present in the original source document and are preserved here.
