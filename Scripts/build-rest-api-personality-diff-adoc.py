...
Operation-level REST API differences between the AFX personality and Unified ONTAP for ONTAP 9.19.1. Only endpoints with at least one HTTP operation present in one personality and absent from the other are listed.
...
Common REST APIs shared by both personalities are intentionally excluded.
