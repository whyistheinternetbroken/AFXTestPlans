...
image::images/test-03-image-01.png[width=50%,link=images/test-03-image-01.png,border]

Select “data” for the interface type and select the desired options, specify a name, home node, etc.

image::images/test-03-image-02.png[width=50%,link=images/test-03-image-02.png,border]
