...
*Contents:*
* <<t04-manage-intercluster-network-interfaces,Manage intercluster network interfaces (steps 1-8)>>
* <<t04-cluster-and-svm-peering,Cluster and SVM peering (steps 9-16)>>
* <<t04-establish-snapmirror-afx-to-unified-ontap,Establish SnapMirror from AFX to unified ONTAP (steps 17-20)>>
* <<t04-create-snapmirror-cli-steps,Create SnapMirror - CLI steps (steps 21-25)>>
...
* <<t04-break-the-snapmirror,Break the SnapMirror (steps 32-34)>>
* <<t04-establish-snapmirror-from-unified-ontap-to-afx,Establish SnapMirror from unified ONTAP to AFX (steps 35-37)>>
* <<t04-reverse-resync-snapmirror,Reverse resync SnapMirror (steps 38-40)>>
