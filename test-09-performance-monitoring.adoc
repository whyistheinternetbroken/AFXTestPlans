...
a| *Test procedure:* +
. Verify performance tests are running. Performance tests can be real data or benchmarks. From the System Manager GUI Login to System Manager. On the main page, you can see performance graphs on the right. This shows if there is activity in the cluster.
+
